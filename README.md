...
<br>
__A:__ Grabbing data from Google Maps API, specifically, directions (A to B) & street view data. Creating html file using Angular as framework.

__Q:__ What is the required output?
<br>
__A:__ Using this data, we can create a road trip experience using screenshots via Google Street View. The images will animate over a set interval to create the experience of driving.
